...
'// Version: 1.5 - Okt 10, 2015 - Johan Arwidmark & Mikael Nystrom
'//
...
Function SetModelAlias()
	...
	oLogging.CreateEntry "UserExit: Product is now " & sProduct, LogTypeInfo
    ...
    Select Case sMake
		...
		Case "HP EliteBook 8560w (LG663EA#AK8)"
		    SetModelAlias = "HP EliteBook 8560w"
		Case "HP EliteBook 8560w Hewlett Packard"
		    SetModelAlias = "HP EliteBook 8560w"
                Case Else
                    SetModelAlias = sModel 
        ...
        Case ""
			...
			'Case "GKPPT10H"
			'	SetModelAlias = "Intel NUC DC3217IYE"
            Case Else
                    SetModelAlias = sProduct 
                    oLogging.CreateEntry "UserExit: Alias rule not found.  ModelAlias set to Product." , LogTypeInfo
        End Select
        Case "Intel"
			Select Case sProduct
			'Case "GKPPT10H"
